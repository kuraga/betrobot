...
class CornersFirstPeriodStatisticFitter(StatisticFitter):
    ...
    def _get_match_statistic_data(self, whoscored_match):
        (corners_first_period_home_count, corners_first_period_away_count) = count_events_of_teams(disjunction(is_corner, is_first_period), whoscored_match)
...
class CornersSecondPeriodStatisticFitter(StatisticFitter):
    ...
    def _get_match_statistic_data(self, whoscored_match):
        (corners_second_period_home_count, corners_second_period_away_count) = count_events_of_teams(disjunction(is_corner, is_second_period), whoscored_match)
