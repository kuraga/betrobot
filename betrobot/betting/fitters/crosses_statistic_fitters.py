...
from betrobot.util.sport_util import count_events_of_teams, is_cross, is_first_period, is_second_period
...
class CrossesFirstPeriodStatisticFitter(StatisticFitter):
    ...
    def _get_match_statistic_data(self, whoscored_match):
        (crosses_first_period_home_count, crosses_first_period_away_count) = count_events_of_teams(disjunction(is_cross, is_first_period), whoscored_match)
...
class CrossesSecondPeriodStatisticFitter(StatisticFitter):
    ...
    def _get_match_statistic_data(self, whoscored_match):
        (crosses_second_period_home_count, crosses_second_period_away_count) = count_events_of_teams(disjunction(is_cross, is_second_period), whoscored_match)
