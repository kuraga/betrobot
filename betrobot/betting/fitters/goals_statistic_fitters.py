...
class GoalsFirstPeriodStatisticFitter(StatisticFitter):
    ...
    def _get_match_statistic_data(self, whoscored_match):
        (goals_first_period_home_count, goals_first_period_away_count) = count_events_of_teams(disjunction(is_goal, is_first_period), whoscored_match)
...
class GoalsSecondPeriodStatisticFitter(StatisticFitter):
    ...
    def _get_match_statistic_data(self, whoscored_match):
        (goals_second_period_home_count, goals_second_period_away_count) = count_events_of_teams(disjunction(is_goal, is_second_period), whoscored_match)
