...
class YellowCardsFirstPeriodStatisticFitter(StatisticFitter):
    ...
    def _get_match_statistic_data(self, whoscored_match):
        (yellow_cards_first_period_home_count, yellow_cards_first_period_away_count) = count_events_of_teams(disjunction(is_yellow_card, is_first_period), whoscored_match)
...
class YellowCardsSecondPeriodStatisticFitter(StatisticFitter):
    ...
    def _get_match_statistic_data(self, whoscored_match):
        (yellow_cards_second_period_home_count, yellow_cards_second_period_away_count) = count_events_of_teams(disjunction(is_yellow_card, is_second_period), whoscored_match)
