...
class CornersViaPassesAttackDefenseResultPredictor(CornersMatchPredictorMixin, Predictor):
    ...
    _pick = [ '_crosses_attack_defense_predictor', '_shots_attack_defense_predictor' ]
    ...
    def __init__(self, *args, **kwargs):
         ...
         self._shots_attack_defense_predictor = AttackDefensePredictor(*args, **kwargs)
    ...
    def _predict(self, fitteds, betcity_match):
         ...
         shots_prediction = self._shots_attack_defense_predictor._predict([ shots_events_mean_fitted, shots_matches_data_fitted ], betcity_match)
    ...
    def _get_runtime_strs(self):
        return [
            ...
            '_shots_attack_defense_predictor=%s' % (str(self._shots_attack_defense_predictor),)
        ]
