...
class GoalsFirstPeriodHandicapsHomeProposer(MainMatchProposer):
...
class GoalsFirstPeriodHandicapsAwayProposer(MainMatchProposer):
...
class GoalsSecondPeriodHandicapsHomeProposer(MainMatchProposer):
...
class GoalsSecondPeriodHandicapsAwayProposer(MainMatchProposer):
