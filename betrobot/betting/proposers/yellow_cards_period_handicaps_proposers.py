...
class YellowCardsFirstPeriodHandicapsHomeProposer(YellowCardsMatchProposer):
...
class YellowCardsFirstPeriodHandicapsAwayProposer(YellowCardsMatchProposer):
...
class YellowCardsSecondPeriodHandicapsHomeProposer(YellowCardsMatchProposer):
...
class YellowCardsSecondPeriodHandicapsAwayProposer(YellowCardsMatchProposer):
