...
def _get_pattern_of_betarch_bet(betarch_bet, betarch_match):
    ...
    rules = {
        ...
        ('*', 'Исход', '', '12', None):                                            lambda betarch_bet: (match_special_word, 'Исход', 'матч', '12'),
        ('*', 'Исход', '', 'X', None):                                             lambda betarch_bet: (match_special_word, 'Исход', 'матч', 'X'),
        ...
        ('*', 'Исходы по таймам (1-й тайм)', '', '12', None):                      lambda betarch_bet: (match_special_word, 'Исход', '1-й тайм', '12'),
        ('*', 'Исходы по таймам (1-й тайм)', '', 'X', None):                       lambda betarch_bet: (match_special_word, 'Исход', '1-й тайм', 'X'),
        ...
        ('*', 'Исходы по таймам (2-й тайм)', '', '12', None):                      lambda betarch_bet: (match_special_word, 'Исход', '2-й тайм', '12'),
        ('*', 'Исходы по таймам (2-й тайм)', '', 'X', None):                       lambda betarch_bet: (match_special_word, 'Исход', '2-й тайм', 'X'),
