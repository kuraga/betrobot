...
for train_sampler_name, train_sampler in train_samplers.items():
    ...
    provider2 = Provider(name, description, train_sampler, corners_first_period_attack_defense_fitter, corners_result_probabilities_attack_defense_predictor, corners_first_period_results_proposers_data)
    ...
    provider3 = Provider(name, description, train_sampler, corners_second_period_attack_defense_fitter, corners_result_probabilities_attack_defense_predictor, corners_second_period_results_proposers_data)
