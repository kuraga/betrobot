...
python3 sets/corners_via_passes_attack_defense/fit.py
./sets/corners_via_passes_attack_defense/experiment.sh

python3 sets/corners_via_passes_periods_attack_defense/fit.py
./sets/corners_via_passes_periods_attack_defense/experiment.sh
